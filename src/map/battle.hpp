...
// eAthena additions
	...
	int block_body_relocation_confine;
	int block_back_slide_ankle;
	int block_back_slide_spiderweb;
	int block_high_jump_ankle;
	int block_high_jump_spiderweb;
	int trickdead_noexp;
	int endure_hit;
	//int magnus_all_element;
	int blitz_damage_divide;
	int sonic_blow_autoattack;
	int bowling_bash_multi_hit;
	int pvp_mvp_map;
	int broadcast_sound;
	...
	//puppy autoattack
	int autoattack_interval;
	int autoattack_wing_itemid;
	int autoattack_wing_time;
	int pickitem_first;
	int autobuff_interval;
	int autoattack_wing_hp_min;
	int autoattack_out_rest;
