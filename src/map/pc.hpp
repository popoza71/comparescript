...
struct autopots {
	int hp_rate, sp_rate, hp_nameid, sp_nameid, delay_rate, hp_rate_max, sp_rate_max;
	unsigned int hp_auto : 1;
...
public:
	...
	int autoattack_dir_x;
	int autoattack_dir_y;

	int autoattack_fitem_x;
	int autoattack_fitem_y;
	int autoattack_mob_id;

	t_tick autoattack_wing_time;
	t_tick autoattack_pickuptime;

	bool autoattack_need_rest;
	bool autoattack_force_wing;


	t_tick autoattack_can_sit;

	bool check_monster_in_cell;
