...
#define SCRIPT_CONSTANTS_HPP
	...
	export_parameter(GOLDPC_POINT_VAR, SP_GOLDPC_POINTS); //goldpc
	...
	//PUPPY EXTRA BUFF
	export_constant(SC_BONUSEXP);
	export_constant(SC_BONUSJOB);
	export_constant(SC_BONUSDROP);

	export_constant(SC_BONUSEXP2);
	export_constant(SC_BONUSJOB2);
	export_constant(SC_BONUSDROP2);

	//PUPPY AI
	export_constant(SC_AUTOAI);
	export_constant(SC_AUTOPOT);

	export_constant(SC_PKPASS_ATK);
	export_constant(SC_PKPASS_DEF);
...
/// @APIHOOK_START(EFST_CONST)
	...
	//PUPPY EXTRA BUFF
	export_constant(EFST_BONUSEXP);
	export_constant(EFST_BONUSJOB);
	export_constant(EFST_BONUSDROP);

	export_constant(EFST_BONUSEXP2);
	export_constant(EFST_BONUSJOB2);
	export_constant(EFST_BONUSDROP2);

	//PUPPY AI
	export_constant(EFST_AUTOAI);
	...
	//PK Pass
	export_constant(EFST_PKPASS_ATK);
	export_constant(EFST_PKPASS_DEF);

	// Party Bonus
	export_constant(EFST_PARTY_SWORDMAN);
	export_constant(EFST_PARTY_ACOLYTE);
	export_constant(EFST_PARTY_ARCHER);
	export_constant(EFST_PARTY_MAGE);
	export_constant(EFST_PARTY_MERCHANT);
	export_constant(EFST_PARTY_THIEF);
	export_constant(EFST_PARTY_KNIGHT);
	export_constant(EFST_PARTY_PRIEST);
	export_constant(EFST_PARTY_HUNTER);
	export_constant(EFST_PARTY_WIZARD);
	export_constant(EFST_PARTY_BLACKSMITH);
	export_constant(EFST_PARTY_ASSASSIN);
	export_constant(EFST_PARTY_CUSADER);
	export_constant(EFST_PARTY_MONK);
	export_constant(EFST_PARTY_BARD);
	export_constant(EFST_PARTY_DANCER);
	export_constant(EFST_PARTY_SAGE);
	export_constant(EFST_PARTY_ALCHEMIST);
	export_constant(EFST_PARTY_ROGUE);
	export_constant(EFST_PJ_ACOLYTE);
	export_constant(EFST_PJ_ALL);
	export_constant(EFST_PJ_ARCHER);
	export_constant(EFST_PJ_MAGE);
	export_constant(EFST_PJ_MERCHANT);
	export_constant(EFST_PJ_SWORDMAN);
	export_constant(EFST_PJ_THIEF);
