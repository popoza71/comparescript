...
enum _sp {
	...
	SP_CHP_MAGIC_DRAIN, SP_CHP_MAGIC_DRAIN_RACE, SC_CHP_MAGIC_DRAIN_CLASS, SC_CHP_MAGIC_DRAINP_RATE,
	SP_CSP_MAGIC_DRAIN, SP_CSP_MAGIC_DRAIN_RACE, SC_CSP_MAGIC_DRAIN_CLASS, SC_CSP_MAGIC_DRAINP_RATE
};
